...
public class SpikeRenderer implements BlockEntityRenderer<SpikeBlockEntity> {
    ...
    static {
        ...
        registerMaterial(SpikeMaterial.WOOD, ResourceLocationHelper.withDefaultNamespace("block/stripped_oak_log"), builder::put);
        registerMaterial(SpikeMaterial.STONE, ResourceLocationHelper.withDefaultNamespace("block/smooth_stone"), builder::put);
        registerMaterial(SpikeMaterial.IRON, ResourceLocationHelper.withDefaultNamespace("block/iron_block"), builder::put);
        registerMaterial(SpikeMaterial.GOLD, ResourceLocationHelper.withDefaultNamespace("block/gold_block"), builder::put);
        registerMaterial(SpikeMaterial.DIAMOND, ResourceLocationHelper.withDefaultNamespace("block/diamond_block"), builder::put);
        registerMaterial(SpikeMaterial.NETHERITE, ResourceLocationHelper.withDefaultNamespace("block/netherite_block"), builder::put);
    ...
    private static final ModelPartCopy INVENTORY_MODEL = ShapeModelPart.pyramid(-8.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F, true);
