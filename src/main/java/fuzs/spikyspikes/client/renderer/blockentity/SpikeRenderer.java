...
public class SpikeRenderer implements BlockEntityRenderer<SpikeBlockEntity> {
    private static final Map<SpikeMaterial, Material> MATERIAL_BY_TYPE = Util.make(Maps.<SpikeMaterial, ResourceLocation>newHashMap(), (p_112552_) -> {
        p_112552_.put(SpikeMaterial.WOOD, new ResourceLocation("block/stripped_oak_log"));
        p_112552_.put(SpikeMaterial.STONE, new ResourceLocation("block/smooth_stone"));
        p_112552_.put(SpikeMaterial.IRON, new ResourceLocation("block/iron_block"));
        p_112552_.put(SpikeMaterial.GOLD, new ResourceLocation("block/gold_block"));
        p_112552_.put(SpikeMaterial.DIAMOND, new ResourceLocation("block/diamond_block"));
        p_112552_.put(SpikeMaterial.NETHERITE, new ResourceLocation("block/netherite_block"));
